...
object PillboxSpec {
    ...
    val LIGHT_SENSOR_2_CHARACTERISTIC_UUID: UUID = UUID.fromString("0000ab02-b5a3-f393-e0a9-e50e24dcca9e")

    val TILT_SENSOR_CHARACTERISTIC_UUID: UUID = UUID.fromString("0000ab03-b5a3-f393-e0a9-e50e24dcca9e")
